      ...
      <div className="bg-gray-50 h-auto md:h-1/2 w-full flex md:flex-row flex-col justify-center items-center p-0 md:p-0">
        <div className="p-5 flex items-center">
          <div class="flex items-center p-3 w-72 h-28   rounded-md shadow-lg bg-light dark:bg-dark">
            ...
            <section class="flex justify-center items-center w-16 h-16 rounded-full hover:cursor-pointer hover:scale-110 duration-300">
              <Image
                src={profileImg}
                alt="Profile Image"
                class="w-full h-auto rounded-full filter dark:invert"
              />
            </section>
