...
const FeaturedPosts = ({ blogs }) => {
  ...
  return (
    <section className="w-full mt-8 sm:mt-24 md:mt-32 px-5 sm:px-10 md:px-0 sxl:px-32 flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-8 ">
        ...
        <article className="col-span-1 sm:col-span-2 lg:col-span-1 row-span-2 relative">
