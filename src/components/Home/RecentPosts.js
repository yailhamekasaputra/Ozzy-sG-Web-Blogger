  ...
  return (
    <section className="w-full mt-8 sm:mt-24 md:mt-32 px-5 sm:px-10 md:px-24 sxl:px-32 flex flex-col items-center justify-center">
      <div className="w-full flex items-center justify-between px-0 sm:px-0 md:px-0">
        ...
        <Link
          href="/categories/all"
          className="relative inline-block w-24 sm:w-28 md:w-40 h-auto cursor-pointer bg-transparent p-0 text-xs sm:text-sm font-medium text-accent dark:text-accentDark outline-none border-0 group mt-1"
        >
          {/* Lingkaran */}
